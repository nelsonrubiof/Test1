 ...
 * @author Sebastian
 */
public class GetAllByUserNameAndSortByCorporateIdCommand {
     ...
     */
    public List<Subscription> execute(String userName) {

        return SpringSupport.getInstance()
                .findBeanByClassName(SubscriptionDAO.class).getForUserNameSortedByCorporateIdAsc(userName);
    }
}
