...
public class GetAllByCorporateNameCommand {
     ...
     */
    public List<OperatorQueuePriority> execute() {
        log.debug("executing execute()");
        return SpringSupport.getInstance().findBeanByClassName(OperatorQueuePriorityDAO.class).listByCorporateName();
    }
