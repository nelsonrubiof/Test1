 ...
 * @author Sebastian
 */
public class SaveOperatorQueuePriorityCommand {

    private static Logger log = Logger.getLogger(SaveOperatorQueuePriorityCommand.class);

    /**
     * Saves an OperatorQueuePriority object
     * @param operatorQueuePriority
     */
    public void execute(OperatorQueuePriority operatorQueuePriority) {
        log.info("start");
