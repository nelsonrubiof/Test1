 ...
 * 
 *  Created on Jun 12, 2014, 4:22:34 PM
 * 
 */
...
@Results({
    ...
    @Result(name = "edit", value = "/WEB-INF/jsp/activitylog/activitylog.jsp")
})
@ParentPackage(value = "default")
@Namespace("/")
public class ActivityLogAction extends ActionSupport implements SessionAware {
