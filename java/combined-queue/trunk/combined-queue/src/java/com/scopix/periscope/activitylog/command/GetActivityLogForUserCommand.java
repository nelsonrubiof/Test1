 ...
 * @author Sebastian
 */
public class GetActivityLogForUserCommand {
     ...
     */
    public List<ActivityLog> execute(String userName, Date day, Date start, Date end) {
        ...
        return getActivityLogDAO().getForUserAndDateRange(userName, start, end);
    }
