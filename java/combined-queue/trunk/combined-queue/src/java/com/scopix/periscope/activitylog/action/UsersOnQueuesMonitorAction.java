...
@Results({
    ...
    @Result(name = "edit", value = "/WEB-INF/jsp/activitylog/usersonqueuesmonitor.jsp")
})
@ParentPackage(value = "default")
@Namespace("/")
public class UsersOnQueuesMonitorAction extends ActionSupport implements SessionAware {
