 ...
 *
 * GetCountryListCommand.java
 *
 * Created on 04-08-2008, 07:06:04 PM
 *
 */
 ...
 */
public class GetCountryListCommand {

    public List<Country> execute(Country country) throws ScopixException {
        ...
        try {
            countries = dao.getCountryList(country);
