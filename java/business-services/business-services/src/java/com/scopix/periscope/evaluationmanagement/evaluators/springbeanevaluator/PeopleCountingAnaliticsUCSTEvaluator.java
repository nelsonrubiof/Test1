 ...
 * 
 * 
 *  PeopleCountingAnaliticsUCSTEvaluator.java
 * 
 *  Created on 25-01-2012, 03:13:33 PM
 * 
 */
...
/**
 * Evaluador para situaciones con AnaliticsUC
 * @author nelson
 */
@Evaluator(evaluatorType = Evaluator.EvaluatorType.EVIDENCE_ST, description = "Evaluador para People Counting Analytics UC")
@SpringBean(rootClass = PeopleCountingAnaliticsUCSTEvaluator.class)
public class PeopleCountingAnaliticsUCSTEvaluator implements EvidenceEvaluatorForST {

    private static Logger log = Logger.getLogger(PeopleCountingAnaliticsUCSTEvaluator.class);

    /**
     * Agrega el Pending Evaluation recibido a la cola correspondiente en este caso AUTOMATIC_ANALITICS
     */
    @Override
