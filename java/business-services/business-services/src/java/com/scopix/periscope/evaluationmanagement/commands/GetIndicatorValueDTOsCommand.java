 ...
 *
 * GetIndicatorValueDTOsCommand.java
 *
 ...
 * @author Cesar Abarza
 */
public class GetIndicatorValueDTOsCommand {

    public List<IndicatorValuesDTO> execute(Date startDate, Date endDate, List<Integer> situationTemplateIds,
        ...
        List<IndicatorValuesDTO> dtos = dao.getIndicatorValuesDTOs(startDate, endDate, situationTemplateIds, storeIds);
        return dtos;
    }
}
