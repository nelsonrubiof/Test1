 ...
 *
 * RemoveObservedMetricCommand.java
 *
 * Created on 08-05-2008, 03:05:46 PM
 *
 */
 ...
 */
public class RemoveObservedMetricCommand {
    ...
    public void execute(Integer id) throws ScopixException {
        ...
        try {
            dao.remove(id, ObservedMetric.class);
            ...
            throw new ScopixException("label.observedMetric");
