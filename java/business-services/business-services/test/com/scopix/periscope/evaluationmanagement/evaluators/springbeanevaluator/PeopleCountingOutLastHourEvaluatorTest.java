 ...
 */
@Ignore
public class PeopleCountingOutLastHourEvaluatorTest {

    private static File file;
    private static Logger log = Logger.getLogger(PeopleCountingOutLastHourEvaluatorTest.class);
    ...
    public PeopleCountingOutLastHourEvaluatorTest() {
    }

    @BeforeClass
    public static void setUpClass() throws Exception {
        try {
            System.out.println("PeopleCountingOutLastHourEvaluatorTest");
            ...
            log.error("No es posible crear datos de prueba");
        }
    ...
    public static void tearDownClass() throws Exception {
        try {
            JCIFSUtil fSUtil = new JCIFSUtil();
            fSUtil.deleteFile("//127.0.0.1/periscope.data/corpTest/");
    ...
    public void testEvaluate() throws Exception {
        ...
        PeopleCountingOutLastHourEvaluator instance = new PeopleCountingOutLastHourEvaluator();
        //generar dao
        ...
        if (dao.getBusinessObject() instanceof EvidenceEvaluation) {
            assertEquals(((EvidenceEvaluation) dao.getBusinessObject()).getEvidenceResult().intValue(), 4);
        } else {
