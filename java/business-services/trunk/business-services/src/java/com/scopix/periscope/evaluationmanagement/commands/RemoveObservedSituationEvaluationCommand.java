 ...
 *
 * RemoveObservedSituationEvaluationCommand.java
 *
 * Created on 08-05-2008, 02:22:39 PM
 *
 */
 ...
 */
public class RemoveObservedSituationEvaluationCommand {

    private Logger log = Logger.getLogger(RemoveObservedSituationEvaluationCommand.class);

    public void execute(Integer id) throws ScopixException {
        log.debug("start");
        GenericDAO dao = HibernateSupport.getInstance().findGenericDAO();
        try {
            dao.remove(id, ObservedSituationEvaluation.class);
            ...
            throw new ScopixException("label.observedSituationEvaluation");
