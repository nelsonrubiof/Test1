 ...
 */
public class AddObservedSituationEvaluationCommand {

    private GenericDAO dao;

    public void execute(ObservedSituationEvaluation observedSituationEvaluation) throws ScopixException {
        getDao().save(observedSituationEvaluation);
    }
