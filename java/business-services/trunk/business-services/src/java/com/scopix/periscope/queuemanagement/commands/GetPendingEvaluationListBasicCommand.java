 ...
 */
public class GetPendingEvaluationListBasicCommand {

    private Logger log = Logger.getLogger(GetPendingEvaluationListBasicCommand.class);

    public List<PendingEvaluation> execute(FilteringData filteringData) throws ScopixException {
        log.debug("start");
        ...
        pendingEvaluations = dao.getPendingEvaluationListBasic(filteringData);
