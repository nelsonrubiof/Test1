 ...
 *
 * RemoveEvidenceProviderTypeCommand.java
 *
 * Created on 31-03-2008, 05:26:44 PM
 *
 */
 ...
 */
public class RemoveEvidenceProviderTypeCommand {

    public void execute(Integer id) throws ScopixException {
        GenericDAO dao = HibernateSupport.getInstance().findGenericDAO();

        try {
            dao.remove(id, EvidenceProviderType.class);
