 ...
 *
 * RemoveObservedSituationCommand.java
 *
 * Created on 08-05-2008, 01:44:33 PM
 *
 */
 ...
 */
public class RemoveObservedSituationCommand {

    private Logger log = Logger.getLogger(RemoveObservedSituationCommand.class);

    public void execute(Integer id) throws ScopixException {
        log.debug("start");
        GenericDAO dao = HibernateSupport.getInstance().findGenericDAO();
        try {
            dao.remove(id, ObservedSituation.class);
            ...
            throw new ScopixException("label.observedSituation");
