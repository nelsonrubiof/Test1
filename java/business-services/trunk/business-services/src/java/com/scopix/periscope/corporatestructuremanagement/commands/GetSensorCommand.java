...
public class GetSensorCommand {
    ...
    public Sensor execute(Integer id) throws ScopixException {
        GenericDAO dao = HibernateSupport.getInstance().findGenericDAO();

        Sensor sensor = null;

        try {
            sensor = dao.get(id, Sensor.class);
    ...
    public Sensor execute(String name) throws ScopixException {
