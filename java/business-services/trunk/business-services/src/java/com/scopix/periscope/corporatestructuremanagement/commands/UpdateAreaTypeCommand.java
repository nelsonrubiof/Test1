 ...
 */
public class UpdateAreaTypeCommand {

    public void execute(AreaType areaType) throws ScopixException {
        GenericDAO dao = HibernateSupport.getInstance().findGenericDAO();
        try {
            AreaType areaTypeAux = dao.get(areaType.getId(), AreaType.class);
            areaTypeAux.setName(areaType.getName());
            areaTypeAux.setDescription(areaType.getDescription());
