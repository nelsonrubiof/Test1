 ...
 */
public class GetEvidenceExtractionServicesServerListCommand {
    ...
    public List<EvidenceExtractionServicesServer> execute(EvidenceExtractionServicesServer eess) {
        ...
        List<EvidenceExtractionServicesServer> list = dao.getEvidenceExtractionServicesServersList(eess);
