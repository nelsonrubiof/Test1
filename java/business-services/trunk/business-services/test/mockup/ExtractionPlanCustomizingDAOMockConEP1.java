 ...
 * 
 * 
 *  WizardCustomizingDAOMock.java
 * 
 *  Created on 07-09-2010, 06:02:00 PM
 * 
 */
package mockup;
 ...
 * @author nelson
 */
public class ExtractionPlanCustomizingDAOMockConEP1 implements ExtractionPlanCustomizingDAO {

    private BusinessObject businessObject;

    public ExtractionPlanCustomizingDAOMockConEP1() {
    }
    ...
    /**
     * retorna una lista con 2 ExtractionPlanCustomizing simples generados con ManagerMock.genExtractionPlanSimple
     */
    public List<ExtractionPlanCustomizing> getExtractionPlanCustomizingActiveList(ExtractionPlanCustomizing wizardCustomizing) {
        ...
        customizings.add(ManagerMock.genExtractionPlanSimple(1, true, Boolean.TRUE));
        customizings.add(ManagerMock.genExtractionPlanSimple(2, true, Boolean.TRUE));
        return customizings;
    }

    public List<ExtractionPlanCustomizing> getExtractionPlanCustomizingNullList(ExtractionPlanCustomizing wizardCustomizing) {
        List<ExtractionPlanCustomizing> customizings = new ArrayList<ExtractionPlanCustomizing>();
        customizings.add(ManagerMock.genExtractionPlanSimple(1, true, Boolean.FALSE));
        customizings.add(ManagerMock.genExtractionPlanSimple(2, true, Boolean.FALSE));
        return customizings;
    }
