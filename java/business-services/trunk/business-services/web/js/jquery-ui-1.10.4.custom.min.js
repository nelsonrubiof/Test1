...
(function($) {
	$.widget('custom.combobox', {
		...
		_createShowAllButton: function() {
			...
			$('<a>').attr('tabIndex', -1).appendTo(this.wrapper).removeClass('ui-corner-all').
			addClass('custom-combobox-toggle ui-corner-right').mousedown(function() {
			...
			$(this.wrapper).find('a').append('<span>');
		},
