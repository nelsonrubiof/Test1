...
public class MarksDTO {
    ...
    private List<ShapesDTO> circles;
    private List<ShapesDTO> squares;
    private Boolean withNumber;

    /**
     * @return the circles
     */
    public List<ShapesDTO> getCircles() {
        if (circles == null) {
            circles = new ArrayList<ShapesDTO>();
        }
        return circles;
    }
     ...
     */
    public void setCircles(List<ShapesDTO> circles) {
     ...
     * @return the squares
     */
    public List<ShapesDTO> getSquares() {
        if (squares == null) {
            squares = new ArrayList<ShapesDTO>();
        }
        return squares;
    }
     ...
     */
    public void setSquares(List<ShapesDTO> squares) {
