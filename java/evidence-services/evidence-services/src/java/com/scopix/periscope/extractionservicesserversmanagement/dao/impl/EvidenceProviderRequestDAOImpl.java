...
public class EvidenceProviderRequestDAOImpl implements EvidenceProviderRequestDAO {
	...
	private static final String SAVE = "INSERT INTO evidence_provider_request(device_id, evidence_provider_id, metric_request_id) VALUES (?, ?, ?);";
	...
	public Integer save(EvidenceProviderRequest epr) {
		...
		this.jdbcTemplate.update(new PreparedStatementCreator() {
			...
			public PreparedStatement createPreparedStatement(Connection cnctn) throws SQLException {
				...
				ps.setObject(2, evidenceProviderId);
				ps.setObject(3, metricRequestId);
				return ps;
			}
		}, keyHolder);
