 ...
 * 
 * 
 *  GetAreaTypesForCorporateCommand.java
 * 
 *  Created on 25-09-2013, 03:32:35 PM
 * 
 */
 ...
 */
public class GetAreaTypesForCorporateCommand {
    private SecurityManagementHibernateDAO dao;
    
    public List<AreaTypeDTO> execute(Integer corporateId, String userName) {
        return getDao().getAreaTypesForCorporate(corporateId, userName);
    }
