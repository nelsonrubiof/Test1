 ...
 */
public class GetRolesGroupCommand {

    Logger log = Logger.getLogger(GetRolesGroupCommand.class);

    public RolesGroup execute(int rolesGroupId) throws ScopixException {
        log.debug("start");
        GenericDAO dao = HibernateSupport.getInstance().findGenericDAO();
        RolesGroup rolesGroup = null;
        try {
            rolesGroup = dao.get(rolesGroupId, RolesGroup.class);
