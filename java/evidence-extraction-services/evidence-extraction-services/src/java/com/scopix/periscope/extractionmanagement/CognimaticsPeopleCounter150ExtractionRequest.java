 ...
 */
@Entity
public class CognimaticsPeopleCounter150ExtractionRequest extends EvidenceExtractionRequest {

    private static Logger log = Logger.getLogger(CognimaticsPeopleCounter150ExtractionRequest.class);
