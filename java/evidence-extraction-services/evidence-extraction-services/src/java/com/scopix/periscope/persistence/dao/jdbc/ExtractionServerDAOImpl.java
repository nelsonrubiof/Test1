 ...
 */
@Repository
@SpringBean(rootClass = ExtractionServerDAO.class)
public class ExtractionServerDAOImpl implements ExtractionServerDAO {
	...
	private static final String SAVE = "INSERT INTO extraction_server(server_id) VALUES (?);";
	...
	@Override
	public ExtractionServer get(Integer id) {
	...
	@Override
	public List<ExtractionServer> getAll() {
		return null;
		// jdbcTemplate.query(GET_ALL, new StoreRowMapper());
	}

	@Override
	public void remove(ExtractionServer id) {
	...
	@Override
	public Integer save(ExtractionServer es) {

		KeyHolder keyHolder = new GeneratedKeyHolder();
		final Integer serverId = es.getServerId();
	...
	@Override
	public List<Integer> save(List<ExtractionServer> list) {

		List<Integer> ids = new ArrayList<Integer>();
		for (ExtractionServer item : list) {
			ids.add(save(item));
		}
		return ids;
	}
	...
	@Override
	public void update(ExtractionServer eess) {
	...
	@Override
	public void update(List<ExtractionServer> list) {
