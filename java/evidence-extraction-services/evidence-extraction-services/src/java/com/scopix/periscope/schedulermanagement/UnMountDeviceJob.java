 ...
 *
 * UnMountDeviceJob.java
 *
 * Created on 02-03-2010, 06:15:50 PM
 *
 */
 ...
 */
public class UnMountDeviceJob implements Job {

    private static Logger log = Logger.getLogger(UnMountDeviceJob.class);
    ...
    public void execute(JobExecutionContext jec) throws JobExecutionException {
        ...
        if (!isWorking()) {
            setWorking(true);
            try {
                extractionManager.unMountExternalDevice(data.getString("storeName"));
