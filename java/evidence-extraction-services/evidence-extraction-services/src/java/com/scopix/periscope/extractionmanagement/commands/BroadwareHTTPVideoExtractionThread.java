 ...
 */
public class BroadwareHTTPVideoExtractionThread extends ExtractEvidenceThread {

    private static Logger log = Logger.getLogger(BroadwareHTTPVideoExtractionThread.class);
