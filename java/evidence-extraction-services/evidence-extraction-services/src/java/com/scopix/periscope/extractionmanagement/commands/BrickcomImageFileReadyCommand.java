 ...
 */
public class BrickcomImageFileReadyCommand {

    private static String uploadLocalDir;
    private ExtractionManager extractionManager;
    private static Logger log = Logger.getLogger(BrickcomImageFileReadyCommand.class);

    public BrickcomImageFileReadyCommand() {
        log.info("start");
