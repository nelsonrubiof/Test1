 ...
 *
 * BroadwareHTTPVideoExtractionRequest.java
 *
 ...
 */
@Entity
public class BroadwareHTTPVideoExtractionRequest extends EvidenceExtractionRequest {

    private static Logger log = Logger.getLogger(BroadwareHTTPVideoExtractionRequest.class);
