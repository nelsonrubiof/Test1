 ...
 * @author marko.perich
 */
public class BroadwareVideoExtractionThread extends ExtractEvidenceThread {

    private static Logger log = Logger.getLogger(BroadwareVideoExtractionThread.class);
    private String extractURL;
    private boolean initialized;

    public void init(String extractURL) throws ScopixException {
        log.info("start [extractURL:" + extractURL + "]");
    ...
    public void run() {
        ...
        try {
            ...
            log.error("No es posigle terminar ejecución " + e, e);
        }
        log.info("end");
    }

    private void callBroadware(String urlString) throws ScopixException {
    	log.debug("callBroadware().urlString: " + urlString);
