 ...
 *
 * CognimaticsPeopleCounter150ExtractionCommand.java
 *
 ...
 */
@SpringBean
public class CognimaticsPeopleCounter150ExtractionCommand implements
        ProviderAdaptor<CognimaticsPeopleCounter150ExtractionRequest, CognimaticsPeopleCounter150EvidenceProvider> {

    private Date date;
    private static Logger log = Logger.getLogger(CognimaticsPeopleCounter150ExtractionCommand.class);

    public CognimaticsPeopleCounter150ExtractionCommand() {
    }

    public void execute(CognimaticsPeopleCounter150ExtractionRequest pcER, CognimaticsPeopleCounter150EvidenceProvider evProv,
            Date date) throws
            ScopixException {
        this.date = date;
    ...
    @Override
    public void prepareEvidence(CognimaticsPeopleCounter150ExtractionRequest evidenceRequest,
            CognimaticsPeopleCounter150EvidenceProvider evidenceProvider)
        ...
        try {
            ...
            dateEjecution.add(Calendar.MINUTE, -CognimaticsPeopleCounter150ExtractionRequest.DELAY);
    ...
    private void callPeopleCounting(String urlString, String user, String password, String fileName) throws ScopixException {
	     ...
	     try {
	         ...
	         if (response != null && response.getEntity() != null){
	             ...
	             CognimaticsPeopleCounter150FileReadyCommand cognimaticsPeopleCounter150FileReadyCommand =
	                     new CognimaticsPeopleCounter150FileReadyCommand();
	             cognimaticsPeopleCounter150FileReadyCommand.execute(fileName, newIs);
	         }
    ...
    private CognimaticsPeopleCounter141XmlDefinition parserInputStream(InputStream is) throws ScopixException {
        try {
            ...
            CognimaticsPeopleCounter141XmlDefinition cpcxd = (CognimaticsPeopleCounter141XmlDefinition) dg.parse(is);
            return cpcxd;
        } catch (IOException e) {
    ...
    protected Map<String, Map<String, Integer>> readPeopleCountingFile(InputStream is) throws ScopixException {
    ...
    private void configureDate(Calendar dia, CognimaticsPeopleCounter150ExtractionRequest evidenceRequest) throws ParseException {
