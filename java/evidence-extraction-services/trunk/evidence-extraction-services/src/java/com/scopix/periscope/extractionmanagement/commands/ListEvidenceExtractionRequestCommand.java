 ...
 * @author nelson
 */
public class ListEvidenceExtractionRequestCommand {

    private static Logger log = Logger.getLogger(ListEvidenceExtractionRequestCommand.class);
    ...
    public List<EvidenceExtractionRequest> execute(List<RequestTimeZone> requestTimeZones, Integer dayOfWeek) 
            throws ScopixException {
        log.info("start");
        List<EvidenceExtractionRequest> list = getDao().getEvidenceExtractionRequestByRequestTimeZone(requestTimeZones,
                dayOfWeek);
