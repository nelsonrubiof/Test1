 ...
 */
@Entity
public class PeopleCountingExtractionRequest extends EvidenceExtractionRequest {

    private static Logger log = Logger.getLogger(PeopleCountingExtractionRequest.class);
