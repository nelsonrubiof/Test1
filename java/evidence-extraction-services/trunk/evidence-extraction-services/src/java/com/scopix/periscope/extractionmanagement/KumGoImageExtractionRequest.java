 ...
 */
@Entity
public class KumGoImageExtractionRequest extends EvidenceExtractionRequest {
    private static Logger log = Logger.getLogger(KumGoImageExtractionRequest.class);
