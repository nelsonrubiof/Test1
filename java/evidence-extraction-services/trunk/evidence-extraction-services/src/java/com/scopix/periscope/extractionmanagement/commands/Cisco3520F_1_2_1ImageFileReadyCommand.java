 ...
 * @version 1.0.0
 */
public class Cisco3520F_1_2_1ImageFileReadyCommand {

    private static String uploadLocalDir;
    private ExtractionManager extractionManager;
    private static Logger log = Logger.getLogger(Cisco3520F_1_2_1ImageFileReadyCommand.class);

    /**
     * Constructor para Comonado
     */
    public Cisco3520F_1_2_1ImageFileReadyCommand() {
        log.info("start");
    ...
    /**
     *
     * @param fileName nombew de Archivo a almacenar
     * @param tmp Archivo Temporal
     */
