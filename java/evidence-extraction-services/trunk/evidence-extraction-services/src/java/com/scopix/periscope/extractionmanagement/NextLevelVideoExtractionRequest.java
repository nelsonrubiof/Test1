 ...
 */
@Entity
public class NextLevelVideoExtractionRequest extends EvidenceExtractionRequest {

    private static Logger log = Logger.getLogger(NextLevelVideoExtractionRequest.class);
