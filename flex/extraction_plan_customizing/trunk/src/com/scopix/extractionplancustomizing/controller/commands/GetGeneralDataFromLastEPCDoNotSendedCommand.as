package com.scopix.extractionplancustomizing.controller.commands {
    ...
    public class GetGeneralDataFromLastEPCDoNotSendedCommand extends BaseCommand {
        private var type:String;

        public function GetGeneralDataFromLastEPCDoNotSendedCommand() {
        ...
        public function execute(stId:Number, storeId:Number, sessionId:Number, type:String):void {
            ...
            if (!GlobalParameters.getInstance().test) {
                (webService as ExtractionPlanManagerWebServices).getUltimoExtractionPlanCustomizingNoEnviado(stId, storeId, sessionId);
            }
        }
