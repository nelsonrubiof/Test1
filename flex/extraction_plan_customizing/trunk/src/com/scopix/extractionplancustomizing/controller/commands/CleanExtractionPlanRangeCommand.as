package com.scopix.extractionplancustomizing.controller.commands {
    ...
    public class CleanExtractionPlanRangeCommand extends BaseCommand {
        public function CleanExtractionPlanRangeCommand() {
            super(new CleanExtractionPlanRangeCommandResultEvent(), new WSFaultEvent());
        }
        ...
        public function execute(epcId:Number, daysVO:ArrayOfDayOfWeekVO, sessionId:Number):void {
            ...
            if (!GlobalParameters.getInstance().test) {
                (webService as ExtractionPlanManagerWebServices).cleanExtractionPlanCutomizingDay(epcId, days, sessionId);
            }
        }
