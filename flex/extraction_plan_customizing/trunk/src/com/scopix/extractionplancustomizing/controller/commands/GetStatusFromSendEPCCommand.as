package com.scopix.extractionplancustomizing.controller.commands {
    ...
    public class GetStatusFromSendEPCCommand extends BaseCommand {
        public function GetStatusFromSendEPCCommand() {
        ...
        public function execute(sessionId:Number):void {
            ...
            if (!GlobalParameters.getInstance().test) {
                (webService as CorporateWebServices).getStatusSendEPCExecution(sessionId);
            }
        }
