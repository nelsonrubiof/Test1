package com.scopix.security.controller.actions
{
    ...
    public class LoginAction
    {
                ...
                //Validate because the cookie could be not configured correctly
           	    try {
    	            ...
    	            if (!userSO.data.hasOwnProperty("lang") || userSO.data.lang == "" || userSO.data.lang == "en_US") {
    	                FlexGlobals.topLevelApplication.loginMenu.locale.languageGroup.selectedValue = "en_US";
    	                FlexGlobals.topLevelApplication.loginMenu.locale.loadLanguage("en_US");
    	            }
    	            else {
    	                FlexGlobals.topLevelApplication.loginMenu.locale.languageGroup.selectedValue = "es_ES";
    	                FlexGlobals.topLevelApplication.loginMenu.locale.loadLanguage("es_ES");
    	            }
        ...
        public function loginResult(event:LoginCommandResultEvent):void
        {
	        ...
	        //changing to epc action
	        var epcAction:ExtractionPlanCustomizingAction = ExtractionPlanCustomizingAction.getInstance();
	        
	        epcAction.showCorporateView();
        }
