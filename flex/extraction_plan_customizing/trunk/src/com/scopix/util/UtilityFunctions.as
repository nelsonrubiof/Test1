package com.scopix.util
{
    ...
    public class UtilityFunctions
    {
        ...
        * */
        ...
        public static function getEPTypeDescription(epType:String):String {
            ...
            switch (epType) {
				...
				case "AUTOMATIC_EVIDENCE":
					...
					break;
				case "REAL_RANDOM":
					rs = ResourceManager.getInstance().getString('resources','rangeday.eprdType.realRandom');
					break;
            }
        ...
        public static function compareOrderMetricTemplate(a:Object, b:Object, fields:Array = null):int {
			if ((a as MetricTemplateVO).order.toString() == 'NaN') {
				return 1;
			} else if ((b as MetricTemplateVO).order.toString() == 'NaN') {
				return -1;
			} else if ((a as MetricTemplateVO).order < (b as MetricTemplateVO).order) {
                return -1;
            } else if ((a as MetricTemplateVO).order > (b as MetricTemplateVO).order) {
                return 1;
            } else {
				//se asume que debe ir al final
                return 0;
            }
