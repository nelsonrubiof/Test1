package com.scopix.util 
{
	...
	public class FlexToExcel {
		public function FlexToExcel() {
			throw new IllegalOperationError ("Class FlexToExcel is static. You can't instance this");
		}

		static public function exportDataGrid (dt:AdvancedDataGrid, filename:String="detail.xls", listData:DataGridListData=null):void {
			...
			for each (var obj:Object in dt.dataProvider) {
				...
				for each (var hd:AdvancedDataGridColumn in dt.columns) {
					if (hd.itemRenderer != null) {
						...
						var listData:DataGridListData = new AdvancedDataGridListData(hd.editorDataField,hd.dataField,arr.length+1,"id",dt,1);
