 ...
 * of this value object you may modify the generated sub-class of this class - StatusSendEPCDTO.as.
 */
...
[ExcludeClass]
public class _Super_StatusSendEPCDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _StatusSendEPCDTOEntityMetadata;
    ...
    public function _Super_StatusSendEPCDTO()
    {
        _model = new _StatusSendEPCDTOEntityMetadata(this);
    ...
    {
        var oldValue:int = _internal_max;
        if (oldValue !== value)
        {
            _internal_max = value;
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _StatusSendEPCDTOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _StatusSendEPCDTOEntityMetadata) : void
    {
        var oldValue : _StatusSendEPCDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
