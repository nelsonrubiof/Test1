 ...
 * of this value object you may modify the generated sub-class of this class - ObservedMetricResultDTO.as.
 */
...
[ExcludeClass]
public class _Super_ObservedMetricResultDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ObservedMetricResultDTOEntityMetadata;
    ...
    public function _Super_ObservedMetricResultDTO()
    {
        _model = new _ObservedMetricResultDTOEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ObservedMetricResultDTOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ObservedMetricResultDTOEntityMetadata) : void
    {
        var oldValue : _ObservedMetricResultDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
