 ...
 * of this value object you may modify the generated sub-class of this class - ExtractionPlanMetricDTO.as.
 */
...
[ExcludeClass]
public class _Super_ExtractionPlanMetricDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ExtractionPlanMetricDTOEntityMetadata;
     ...
     * properties
     */
    private var _internal_evaluationOrder : int;
    ...
    private var _internal_metricVariableName : String;
    ...
    public function _Super_ExtractionPlanMetricDTO()
    {
        _model = new _ExtractionPlanMetricDTOEntityMetadata(this);
    ...
    public function get evaluationOrder() : int
    {
        return _internal_evaluationOrder;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get metricVariableName() : String
    {
        return _internal_metricVariableName;
    }
    ...
    public function set evaluationOrder(value:int) : void
    {
        var oldValue:int = _internal_evaluationOrder;
        if (oldValue !== value)
        {
            _internal_evaluationOrder = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "evaluationOrder", oldValue, _internal_evaluationOrder));
        }
    }
    ...
    public function set metricVariableName(value:String) : void
    {
        var oldValue:String = _internal_metricVariableName;
        if (oldValue !== value)
        {
            _internal_metricVariableName = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "metricVariableName", oldValue, _internal_metricVariableName));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ExtractionPlanMetricDTOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ExtractionPlanMetricDTOEntityMetadata) : void
    {
        var oldValue : _ExtractionPlanMetricDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
