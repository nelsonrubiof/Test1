 ...
 * of this value object you may modify the generated sub-class of this class - CountryDTO.as.
 */
...
[ExcludeClass]
public class _Super_CountryDTO extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _CountryDTOEntityMetadata;
    ...
    private var _internal_regions : ArrayCollection;
    model_internal var _internal_regions_leaf:com.scopix.periscope.webservices.businessservices.valueObjects.RegionDTO;
    private var _internal_stores : ArrayCollection;
    model_internal var _internal_stores_leaf:com.scopix.periscope.webservices.businessservices.valueObjects.StoreDTO;
    ...
    public function _Super_CountryDTO()
    {
        _model = new _CountryDTOEntityMetadata(this);
    ...
    public function set regions(value:*) : void
    {
        var oldValue:ArrayCollection = _internal_regions;
        if (oldValue !== value)
        {
            if (value is ArrayCollection)
            {
                _internal_regions = value;
            }
            else if (value is Array)
            {
                _internal_regions = new ArrayCollection(value);
            }
            else if (value == null)
            {
                _internal_regions = null;
            }
            else
            {
                throw new Error("value of regions must be a collection");
            }
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "regions", oldValue, _internal_regions));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _CountryDTOEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _CountryDTOEntityMetadata) : void
    {
        var oldValue : _CountryDTOEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
