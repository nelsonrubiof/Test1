package flex.utils.ui.resize
{
	...
	public class ResizeHandle extends UIComponent
	{
		...
		private static function classConstruct():Boolean {
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizeHandle");
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizeHandle", style, true);
            return true;
        };
