package flex.utils.ui.resize
{
	...
	public class DragHandle extends UIComponent
	{
		...
		private static function classConstruct():Boolean {
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("DragHandle");
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("DragHandle", style, true);
            return true;
        };
