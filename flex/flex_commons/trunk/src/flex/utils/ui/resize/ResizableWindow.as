package flex.utils.ui.resize
{
	...
	// se comenta hasta saber como se utiliza [IconFile("ResizableWindow.png")]
	...
	public class ResizableWindow extends TitleWindow
	{
		...
		private static function classConstruct():Boolean {
            var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizableWindow"); 
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizableWindow", style, true);
            return true;
        };
