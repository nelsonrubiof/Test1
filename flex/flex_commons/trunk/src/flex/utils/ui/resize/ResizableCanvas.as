package flex.utils.ui.resize
{
	...
	// se comenta hasta saber como se utiliza [IconFile("ResizableBox.png")]
	...
	public class ResizableCanvas extends Canvas
	{
		...
		private static function classConstruct():Boolean {
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizableCanvas");
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizableCanvas", style, true);
            return true;
        };
