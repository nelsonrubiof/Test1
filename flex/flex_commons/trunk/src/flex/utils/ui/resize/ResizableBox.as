package flex.utils.ui.resize
{
	...
	public class ResizableBox extends Box
	{
		...
		private static function classConstruct():Boolean {
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizableBox"); 
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizableBox", style, true);
            return true;
        };
