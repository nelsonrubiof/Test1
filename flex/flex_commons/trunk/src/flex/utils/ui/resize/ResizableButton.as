package flex.utils.ui.resize
{
	...
	public class ResizableButton extends Button
	{
		...
		private static function classConstruct():Boolean {
            var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizableButton"); 
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizableButton", style, true);
            return true;
        };
