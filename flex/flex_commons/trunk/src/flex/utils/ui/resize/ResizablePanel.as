package flex.utils.ui.resize
{
	...
	public class ResizablePanel extends Panel
	{
		...
		private static function classConstruct():Boolean {
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizablePanel");
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizablePanel", style, true);
            return true;
        };
