package flex.utils.ui.resize
{
	...
	// se comenta hasta saber como se utiliza [IconFile("ResizableTextArea.png")]
	...
	public class ResizableTextArea extends TextArea
	{
		...
		private static function classConstruct():Boolean {
			var style:CSSStyleDeclaration = FlexGlobals.topLevelApplication.styleManager.getStyleDeclaration("ResizableTextArea");
            if (!style) {
			...
			FlexGlobals.topLevelApplication.styleManager.setStyleDeclaration("ResizableTextArea", style, true);
            return true;
        };
