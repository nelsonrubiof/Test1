...
package com.scopix.periscope.uploadtoexternaldevicemanagement.services.webservices.client.result
{
	...
	public class FormatDeviceResultEvent extends Event
	{
		/**
		 * The event type value
		 */
		public static var FormatDevice_RESULT:String="FormatDevice_result";
		/**
		 * Constructor for the new event type
		 */
		public function FormatDeviceResultEvent()
		{
			super(FormatDevice_RESULT,false,false);
		}
