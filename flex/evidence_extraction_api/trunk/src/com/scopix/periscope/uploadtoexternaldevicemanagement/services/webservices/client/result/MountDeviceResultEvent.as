...
package com.scopix.periscope.uploadtoexternaldevicemanagement.services.webservices.client.result
{
	...
	public class MountDeviceResultEvent extends Event
	{
		/**
		 * The event type value
		 */
		public static var MountDevice_RESULT:String="MountDevice_result";
		/**
		 * Constructor for the new event type
		 */
		public function MountDeviceResultEvent()
		{
			super(MountDevice_RESULT,false,false);
		}
