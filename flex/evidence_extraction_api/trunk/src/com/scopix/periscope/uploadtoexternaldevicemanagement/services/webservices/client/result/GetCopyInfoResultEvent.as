...
package com.scopix.periscope.uploadtoexternaldevicemanagement.services.webservices.client.result
{
	...
	public class GetCopyInfoResultEvent extends Event
	{
		/**
		 * The event type value
		 */
		public static var GetCopyInfo_RESULT:String="GetCopyInfo_result";
		/**
		 * Constructor for the new event type
		 */
		public function GetCopyInfoResultEvent()
		{
			super(GetCopyInfo_RESULT,false,false);
		}
